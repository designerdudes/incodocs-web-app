...
import { SlabInterface } from "./columns";
  ...
  const deleteLot = async () => {
    try {
      const result = await deleteData(
        `/factory-management/inventory/lot/delete/${data._id}`
      );
        ...
        <DropdownMenuContent className="gap-2" align="end">
          ...
          <DropdownMenuItem
            onSelect={() => {
              ...
              GlobalModal.children = <EditSLabForm params={{ _id: data._id }} />; // Render Edit Form
              GlobalModal.onOpen();
            }}
          >
