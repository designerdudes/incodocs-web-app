        ...
        <div className="topbar flex items-center justify-between gap-4 w-full">
          ...
          <div className="flex-1">
            <Heading
              ...
              title={`Details of Customer: ${CustomerData?.customerName}`}
            />
            <p className="text-muted-foreground text-sm mt-2">
              View customer with detailed insights into specifications and
              status.
            </p>
          </div>
        </div>
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>{CustomerData?.gstNo || "N/A"}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="whitespace-nowrap">
                        Mobile Number
                ...
                <Table>
                  ...
                  <tbody>
                    ...
                    CustomerData.documents.length > 0 ? (
                      CustomerData.documents.map((doc: any, index: number) => (
