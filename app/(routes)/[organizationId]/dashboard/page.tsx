  ...
  try {
    ...
    return (
      <main className="flex  flex-col p-10 gap-4 bg-gradient-to-r from-gray-100 to-white">
        <div className="gap-3">
          <Heading className="text-3xl" title="Dashboard" />
        ...
        <OrgDashboardCards organizationId={organizationId} />
        {/* stats cards  */}
        ...
        <div className="gap-3">
          ...
          />
          <p className="text-sm  text-gray-600">
            Overview of all invoices, quotations and purchase orders for your
            organization.
          </p>
        </div>
        <Separator />
        ...
        <Separator />
        <div className="gap-3">
          <Heading className="text-3xl" title="Factories" />
          <p className="text-sm  text-gray-600">
