...
export interface EditContainerTypeModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: { value: string; label: string; category: string }) => void;
}

export function EditContainerTypeModal({
  isOpen,
  onClose,
  onSubmit,
}: EditContainerTypeModalProps) {
  ...
  const handleSubmit = (data: z.infer<typeof containerTypeSchema>) => {
    onSubmit(data);
    toast.success("Container type edited successfully!");
    onClose();
    form.reset();
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Edit New Container Type</DialogTitle>
          <DialogDescription>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="Dry Containers">
                        Dry Containers
                      </SelectItem>
                      <SelectItem value="Refrigerated Containers">
                        Refrigerated Containers
                      </SelectItem>
                      <SelectItem value="Special Dimensioned Containers">
                        Special Dimensioned Containers
                      </SelectItem>
                      <SelectItem value="Custom Containers">
                        Custom Containers
                      </SelectItem>
                    </SelectContent>
                  </Select>
