...
const formSchema = z.object({
    ...
    address: z.object({
        ...
        pincode: z.number().min(6, { message: "Pincode must be at least 6 characters" }),
    }),
...
export default function EditFactoryForm({ params }: Props) {
    ...
    const handleSubmit = (values: z.infer<typeof formSchema>) => {
        ...
        GlobalModal.description = "Are you sure you want to update this Employee Details?";
