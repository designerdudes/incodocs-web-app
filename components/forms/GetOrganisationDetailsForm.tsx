...
interface GetOrganisationDetaisFormProps extends React.HTMLAttributes<HTMLDivElement> {
    gap: number
}
...
export function GetOrganisationDetaisForm({ className, gap, ...props }: GetOrganisationDetaisFormProps) {
